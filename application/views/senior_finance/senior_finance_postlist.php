											...
											<table id="dynamic-table" class="table table-striped  table-hover">
												<thead>
													<tr>
														...
														<th>Amount</th>
														<th>Description</th>
														<th>Personal Acc/Reserved</th>
														
														<th>Account</th>
                                                        <th class="hidden-480">Head F& ADmin</th>
                                                        <th class="hidden-480">Status(SF)</th>
												...
												<tbody>
													...
													<tr>
														...
														<td class="hidden-480"><?php  
														if ($row->Senior_Finance=='Not yet') echo '<span class="label label-sm label-basic">'.$row->Senior_Finance.'</span>'; 
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<?php if (($row->Senior_Finance !='rejected') && ($row->Senior_Finance !='approved')){?>
																<a href="<?php echo base_url();?>senior_finance_post/senior_finance_review_post/<?php echo $row->Post_Id;?>"  title="Review" ><button class="btn btn-xs btn-success">
