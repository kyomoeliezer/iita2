								...
								<form class="form-horizontal" role="form"  method="post">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info verify" onclick="confirm_modal_approval('<?php echo base_url();?>head_finance_post/approve/<?php echo $key->Post_Id;?>');" >
											...
											&nbsp; &nbsp; &nbsp;
											<button class="btn btn-danger"  onclick="showAjaxModal('<?php echo base_url();?>head_finance_post/reject_post/<?php echo $key->Post_Id;?>');">
