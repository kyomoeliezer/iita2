											...
											<table id="dynamic-table" class="table table-striped  table-hover">
												<thead>
													<tr>
														...
														<th class="hidden-480">Bank Name</th>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
                                                               ...
                                                               <?php } if ($this->session->userdata['logged_in']['Senior_Finance_Role']==1){?>
                                                                <a href="javascript:;"  title="Deactivate" onclick="showAjaxModal('<?php echo base_url();?>employee/deactivate_employee/<?php echo $row->Employee_Id;?>');">  <i class="ace-icon fa fa-ban bigger-130"></i></a>
