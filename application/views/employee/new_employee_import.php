					...
					<div class="page-content">
                      ...
                      <?php $this->load->view('common/boot_setting');?>
                       <div class="page-header  col-centered">
							<h1 style="margin-left: 300px;">Import Employee </h1>
						</div>
						...
						<div class="row">
                         ...
                         <?php }?> 
							...
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal"  enctype="multipart/form-data" role="form" action="<?php echo site_url('employee/newemployee_import'); ?>" method="post" >
									<input type="hidden" name="attach_test" value="00" />
									<?php echo validation_errors(); ?>
									<div class="form-group <?php if (!empty(form_error('EmployeeId'))) echo 'has-error';  ?> ">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Employee CSV</label>
								...
								<ul>
									<li>Download Csv Template <a style="text-decoration: none;" href="<?php echo base_url(); ?>post/download/<?php echo '1xcsv_employ_temp';  ?>" title="Download template for the CSV">here</a> </li>
