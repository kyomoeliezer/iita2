											...
											<table id="dynamic-table" class="table table-striped  table-hover">
												<thead>
													<tr>
														...
														<th>Description</th>
														<th>PostID</th>
														<!-- <th>Retirement Doc</th> -->
														<th>Currency</th>
														<th>Conversion Date</th>
														<th>Rate</th>

														<th>Retired(Origin)</th>
														<th>Retired(USD)</th>
													
														<th>Account</th>
														
														<th>Reserved</th>
														<td>Retired Amount</td>
														<td>Status</td>
												...
												<tbody>
													...
													<tr>
														...
														<!-- <td>
															<a href="<?php echo base_url(); ?>post/download/<?php echo $row->fk_payment_Post_Id.'xretiredoc';  ?>"><span ><i class="fa fa-file-pdf-o s-large"></i></span></a>
														...
														<td class="hidden-480">
															<?php $change=$row->Cash_Retired_Origin-$row->Payment_Amount_In_Origin; echo $row->Cash_Retired_Origin;  /* echo ($row->Cash_Retired_Origin-$row->Payment_Amount_In_Origin);*/?>
														</td>
														<td class="hidden-480"><?php echo  $row->Retirement_Status; ?></td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																
																 <?php if ($change != 0){?>
																<a title="Pay extra" href="<?php echo base_url(); ?>payment/extra_pay/<?php echo $row->Post_Id; ?>">
