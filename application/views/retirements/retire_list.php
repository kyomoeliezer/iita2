													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<?php if (($row->Retirement_Status !='approved') && ($row->Retirement_Status !='rejected') &&($row->Retirement_Status !='closed')) { ?>
																<a title="Review" href="<?php echo base_url(); ?>payment/review_retire/<?php echo $row->Post_Id; ?>">  <i class="ace-icon fa fa-calculator bigger-130"></i></a>
																<?php }
                                                                  else echo $row->Retirement_Status;
																 ?>
															</div>
