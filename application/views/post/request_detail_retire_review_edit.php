						...
						<div class="row">
							...
							<div class="col-sm-5">
								<div class="widget-box transparent">
									 		<form class="form-horizontal" id="form"  role="form" action="<?php echo site_url('payment/rejected_edit_payment'); ?>" enctype="multipart/form-data" method="post">
											    ...
											    <?php if (! empty($retiredlist)){
                                                foreach ($retiredlist as $retirerow) {
												...
												<div class="profile-activity clearfix">
													<div class="form-group">
														...
														<div class="col-sm-9">
															<select name="Retirement_Type" id="type" class="col-sm-8"  readonly="true" required="true">
																<option value="Balanced Retirement" <?php if ($retirerow->Retirement_Type=='Balanced Retirement' ) echo 'selected'; ?> >Over Retirement</option>
																<option value="Over Retirement" <?php if ($retirerow->Retirement_Type=='Under Retirement' ) echo 'selected'; ?> >Under Retirement</option>
																
																
																<option value="<?php echo $retirerow->Retirement_Type;  ?>" ><?php echo $retirerow->Retirement_Type;  ?></option>
												...
												<input type="hidden" name="Payment_Id" value="<?php   echo $retirerow->Payment_Id;?>"> 
												
												<div class="profile-activity clearfix">
																<div class="form-group">
																<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Retirement Doc</label>

																<div class="col-sm-9">
																<!-- <input  type="file" name="attach_retire"  data-rel="tooltip"  class="col-sm-8" id="id-date-picker-1" required="true" /> -->
																 <a href="<?php echo base_url(); ?>post/download/<?php echo $retirerow->fk_payment_Post_Id.'xretiredoc';  ?>"><span class="col-sm-8" ><i class="fa fa-file-pdf-o s-large"></i>Download Pdf  </span></a>
												...
												<div class="profile-activity clearfix">
																<div class="form-group">
																<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Change Attachment</label>

																<div class="col-sm-9">
																<input  type="file" name="attach_retire"  data-rel="tooltip"  class="col-sm-8" id="id-date-picker-1"  />
												...
												<div class="profile-activity clearfix">
															<div class="form-group">
																<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Retired Amount</label>

															<div class="col-sm-9">
																<input  type="text" id="" name="Amount" value="<?php echo $retirerow->Cash_Retired_Origin;?>" data-rel="tooltip"  class="col-sm-8"  required="true" />
												...
												<div class="profile-activity clearfix" id="under_amount_div">
																<div class="form-group">
																<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Change Amount</label>

																<div class="col-sm-9">
																<input  type="text" id="under_amount" readonly="true" name="Under_Amount" value="<?php echo $retirerow->Currency.'  '. ($retirerow->Cash_Retired_Origin-$retirerow->Payment_Amount_In_Origin); ?>" data-rel="tooltip"  class="col-sm-8"   />
																
															   </div>
															</div>
												</div>
												<!-- 
														<button class="btn btn-info verify" onclick="confirm_modal_approval('<?php echo base_url();?>Senior_finance_post/approve_retirement/<?php echo $retirerow->fk_payment_Post_Id;?>');" >
...
/*		        	 $('#retire_amount').val(amount);
		...
		$("#retire_amount").change(function(){
			//alert('');
           
		    var ramount = Number($(this).val());
		    var change = Number($('#paid_amount').val()) - ramount;
		  if ($("#type").val() == 'Under Retirement'){
		       $("#under_amount").val(change);
		   }
		 else if ($("#type").val() == 'Over Retirement'){
		       $("#extra_amount").val(change);
		   }
		 });
