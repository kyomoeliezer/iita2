								...
								<div class="widget-box transparent">
									 		<!-- <form class="form-horizontal" id="form"  role="form" action="<?php echo site_url('payment/payin'); ?>" enctype="multipart/form-data" method="post">	 -->
												...
												<div class="widget-header widget-header-small">
													<h4 class="widget-title blue smaller">
														<i class="ace-icon fa fa-rss orange"></i>
														 Over / Under Payments <span class="pull-right"><a style="text-decoration: none;"   href="<?php echo base_url(); ?>payment/print_change/<?php echo $Post_Id;   ?>"><i class="fa fa-print"></i>Receipt</a></span>
													</h4>
												...
												<div class="profile-activity clearfix">
																...
																<div class="col-sm-9">
																<input  type="text" id="" readonly="true" name="Amount" value="<?php echo $retirerow->Currency.'  '.$retirerow->Cash_Retired_Origin;?>" data-rel="tooltip"  class="col-sm-8"  required="true" />
												...
												<form  id="form" method="post" action="<?php echo base_url(); ?>payment/close_retirement">
												
														<input type="hidden" name="Payment_Id" value="<?php echo $retirerow->Payment_Id; ?>" >
														 <input id="delete_button" class="floatright btn btn-info" type="button" value="Close" /> 
																
																<!-- </form> -->
																
																&nbsp; &nbsp; &nbsp;
																<!-- <button class="btn btn-danger"  onclick="showAjaxModal('<?php echo base_url();?>Senior_finance_post/reject_retirement/<?php echo $retirerow->fk_payment_Post_Id;?>');">
