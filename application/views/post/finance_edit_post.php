						...
						<div class="row">
                         ...
                         <?php foreach ($postlist as $rqst) {?>
							...
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo site_url('post/edit_post'); ?>" enctype="multipart/form-data" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9 input-group">
											...
											<table style="border-collapse:separate; border-spacing:1.4em;">
												...
												<tr id="">
													<td>
														<select  name="Center[]" id="" class="form-control col-xs-10 col-sm-5" data-rel="tooltip"   data-placeholder="">
															<option value="">Choose center...  </option>
			                                                <?php foreach ($centerlist as $row ) {?>
													...
													<td style="padding-right: 10px">
														<input  type="number" min="0"  step="any" name="Amount[]" data-rel="tooltip" value="<?php echo set_value('Amount_shared1'); ?>"  class="" id="id-amount" placeholder="" />
														<?php echo '<span class="text-danger">'. form_error('Amount').'</span>'; ?>
									...
									<div class="form-group travel  <?php if (!empty(form_error('attach'))) echo 'has-error';  ?>">
										...
										<div class="col-sm-9 form-fields">
									            ...
									            <table class="col-xs-10">
									              ...
									              <?php
									              foreach ($travel_list as $tlist) {?>
									              <tr id="test">
									                <td width="20%">
									                	<input type="hidden" id="travel_id" name="travel_id[]" style="width:100%;" value="<?php echo $tlist->Travel_Id; ?>" />

									                	<input type="text" name="from[]" style="width:100%;" value="<?php echo $tlist->City_From; ?>" /></td>
									                <td width="20%"><input type="text" name="to[]" style="width:100%;" value="<?php echo $tlist->City_To; ?>"/></td>
									                <td width="20%"><input type="text" class="date-picker" name="departure[]" style="width:100%;" data-date-format="yyyy-mm-dd" value="<?php echo $tlist->Departure_Date; ?>" /></td>
									                <td width="20%"><input type="text" class="date-picker" name="arrival[]" style="width:100%;" data-date-format="yyyy-mm-dd"  value="<?php echo $tlist->Arrival_Date; ?>"/></td>
