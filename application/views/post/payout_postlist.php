													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a href="javascript:;"  title="Edit" onclick="showAjaxModal('<?php echo base_url();?>post/edit_post/<?php echo $row->Post_Id;?>');">  <i class="ace-icon fa fa-pencil bigger-130"></i></a>
                                                              ...
                                                              <!--   <?php if (($row->Budget_Holder=='approved')&& ($row->Head_Finance_Admin=='approved') && ($row->Senior_Finance=='approved') &&($row->Post_Status !='retired') &&($row->Post_Status !='paid')){?>
                                                                <a href="<?php echo base_url();?>payment/payout/<?php echo $row->Post_Id;?>"  title="Review" >  <i class="ace-icon fa fa-money bigger-130"></i></a>
                                                                <?php }?> -->
