					...
					<div class="page-content">
                      ...
                      <?php $this->load->view('common/boot_setting');?>
                       <div class="page-header  col-centered">
							<h1 style="margin-left: 300px;">New Bank <span class="pull-right"><a href="<?php echo base_url();?>banks/newbank_import"><button class="btn btn-info">Import CSV</button></a></span></h1>
						</div>
						...
						<div class="row">
                         ...
                         <?php }?> 
							...
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo site_url('banks/newbank'); ?>" method="post">
									...
									<div class="form-group  <?php if (!empty(form_error('bankname'))) echo 'has-error';  ?> ">
										...
										<div class="col-sm-9">
											<input  type="text" name="bankname" data-rel="tooltip" class="col-xs-10 col-sm-5" id="form-input" value="<?php echo set_value('bankname'); ?>" />
