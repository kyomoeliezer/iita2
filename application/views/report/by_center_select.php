                       ...
                       <div class="page-header  col-centered">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo site_url('report/report_by_center'); ?>"  method="post" enctype="multipart/form-data">
													...
													<td>
														<select  name="center" class="form-control col-xs-10 col-sm-5 chosen-select" data-rel="tooltip"  data-placeholder="">
			                                                ...
			                                                <?php foreach ($centerlist as $row ) {?>
			                                                  ...
			                                                  <option value="<?php echo $row->CenterNo; ?>" <?php if (set_value('center')==$row->CenterId) echo ' selected';?>><?php echo $row->CenterNo; ?></option>
