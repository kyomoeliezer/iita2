					...
					<div class="page-content">
                      ...
                      <?php $this->load->view('common/boot_setting');?>
                       <div class="page-header  col-centered">
							<h1 style="margin-left: 300px;">Report Per Account </h1>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo site_url('report/report_by_account'); ?>"  method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-12 input-group">
											<table style="border-collapse:separate; border-spacing:1.4em;">
												...
												<tr id="tr_single">
													<td>
														<select  name="account" class="form-control col-xs-10 col-sm-5 chosen-select" data-rel="tooltip"  data-placeholder="">
															<option value="all">All  </option>
			                                                <?php foreach ($accountlist as $row ) {?>
			                                                  
			                                                  <option value="<?php echo $row->AccountNo; ?>" <?php if (set_value('account')==$row->Account_Id) echo ' selected';?>><?php echo $row->AccountNo.': '.$row->Account_Description ; ?></option>
			                                                	
			                                                 <?php  } ?>
																		
														</select>
														<?php echo '<span class="text-danger">'. form_error('account').'</span>'; ?>
