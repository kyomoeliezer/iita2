                       ...
                       <div class="page-header  col-centered">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo site_url('report/report_by_person'); ?>"  method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-12 input-group">
											<table style="border-collapse:separate; border-spacing:1.4em;">
												...
												<tr id="tr_single">
													<td>
														<select  name="reserved" class="form-control col-xs-10 col-sm-5 chosen-select" data-rel="tooltip"  data-placeholder="">
															<option value="all">All   </option>
			                                                <?php  foreach ($personlist as $row ) {?>
			                                                  
			                                                  <option value="<?php echo $row->EmploymentNo; ?>" <?php if (set_value('reserved')==$row->Employee_Id) echo ' selected';?>><?php echo  $row->EmploymentNo ; ?></option>
			                                                	
			                                                 <?php  } ?>
																		
														</select>
														<?php echo '<span class="text-danger">'. form_error('reserved').'</span>'; ?>
