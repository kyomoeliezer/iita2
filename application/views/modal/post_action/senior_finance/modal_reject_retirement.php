                       ...
                       <div class="page-header  col-centered">
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal reject" role="form" method="post" action="<?php echo base_url(); ?>senior_finance_post/reject_retirement">
									...
									<div class="form-group" >
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Post ID</label>
...
$('.reject').submit( function (ev) {
  ...
  if($('#Reject_Reason').val() == ''){
      ...
      $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>senior_finance_post/reject_retirement',
      ...
      success:  function(data){
        ...
        /*location.reload();*/
        window.location.replace("<?php echo base_url(); ?>payment/retired_list");
      }
