					...
					<div class="page-content">
                       ...
                       <div class="page-header  col-centered">
							<h1 style="margin-left: 100px; font-size: 17px;">Activate employee ! </h1>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
		                       ...
		                       <input  type="email" name="Email" data-rel="tooltip" readonly="true"  class="col-xs-10" value="<?php echo $key->Email; ?>" required="true" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Reason</label>

										<div class="col-md-8">
											<textarea style="color:orange;" type="text" required="true" name="Reason" value="" class="col-xs-10"><?php if (! empty($key->Reject_Reason)) echo $key->Reject_Reason; else echo "First Created need your approval"; ?></textarea>
...
$('.edit').submit( function (ev) {
  ...
  if($('#Employee_Id').val() == ''){
      ...
      $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>employee/activate_employee',
      data:$('.edit').serialize(),
