					...
					<div class="page-content">
                       ...
                       <div class="page-header  col-centered">
							<h1 style="margin-left: 100px; font-size: 17px;">Deactivate employee ! </h1>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
		                       ...
		                       <input  type="email" name="Email" data-rel="tooltip" readonly="true"  class="col-xs-10" value="<?php echo $key->Email; ?>" required="true" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Deactivation Reason</label>
...
$('.edit').submit( function (ev) {
  ...
  if($('#Employee_Id').val() == ''){
      ...
      $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>employee/deactivate_employee',
      data:$('.edit').serialize(),
