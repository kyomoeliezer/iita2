					...
					<div class="page-content">
                      ...
                      <?php $this->load->view('common/boot_setting');?>
                       <div class="page-header  col-centered">
							<h1 style="margin-left: 300px;">Request Review </h1>
						</div>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form"  method="post">
									...
									<div class="form-group  <?php if (!empty(form_error('Center_Id'))) echo 'has-error';  ?> ">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Center/<?php echo '<span  style="color:orange;">'. $key->Costing_type; ?></span></label>
									...
									<div class="form-group  <?php if (!empty(form_error('Amount'))) echo 'has-error';  ?> ">
										...
										<div class="input-group">
											<span class="input-group-addon">
											 ...
											 <input type="text"  name="Amount"  id="amount" class="col-xs-4" data-rel="tooltip" autocomplete="off" maxlength="50" value="<?php echo $key->Amount; ?>" readonly="true"/>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info verify" onclick="confirm_modal_approval('<?php echo base_url();?>b_h_post/b_h_approve/<?php echo $key->Request_Details_Id;?>');" >
											...
											&nbsp; &nbsp; &nbsp;
											<button class="btn btn-danger"  onclick="showAjaxModal('<?php echo base_url();?>b_h_post/reject_post/<?php echo $key->Post_Id;?>x<?php echo $key->Request_Details_Id;?>');">
