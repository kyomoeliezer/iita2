											...
											<table id="dynamic-table" class="table table-striped table-hover">
												<thead>
													<tr>
                                                        ...
                                                        <th class="hidden-480">Status(BH)</th>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a href="<?php echo base_url(); ?>post/payed_details/<?php echo $row->Request_Details_Id; ?>"><?php echo  $row->Post_Id; ?></a>
														</td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<?php if (($row->Budget_Holder !='rejected') && ($row->Budget_Holder !='approved')){?>
																<a href="<?php echo base_url();?>b_h_post/b_h_review_post/<?php echo $row->Request_Details_Id;?>"  title="Review" ><button class="btn btn-xs btn-success">
