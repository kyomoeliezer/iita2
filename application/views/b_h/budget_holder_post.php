					...
					<div class="page-content">
                      ...
                      <?php $this->load->view('common/boot_setting');?>
                       <div class="page-header  col-centered">
							<h1 style="margin-left: 300px;">New Post </h1>
						</div>
						...
						<div class="row">
                         ...
                         <?php }?> 
							...
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo site_url('post/newpost'); ?>" method="post">
									...
									<div class="form-group  <?php if (!empty(form_error('Person_Id'))) echo 'has-error';  ?> ">
										...
										<div class="col-sm-4">
											<select name="Person_Id" class="col-xs-10 col-sm-5 chosen-select"  data-rel="tooltip"  data-placeholder="" >
												<option value="">Choose staff...  </option>
                                                <?php foreach ($personlist as $key ) {?>
                                                  
                                                  <option value="<?php echo $key->Employee_Id; ?>" <?php if (set_value('Person_Id')==$key->Employee_Id) echo ' selected';?>><?php echo $key->First_Name .' '.$key->Last_Name ; ?></option>
									...
									<div class="form-group  <?php if (!empty(form_error('Center_Id'))) echo 'has-error';  ?> ">
										...
										<div class="col-sm-4">
											<select  name="Center_Id" class="col-xs-10 col-sm-5 chosen-select" data-rel="tooltip"  data-placeholder="">
											...
											<?php echo '<span class="text-danger">'. form_error('Center_Id').'</span>'; ?>
										</div>
									</div>
									<div class="form-group  <?php if (!empty(form_error('Account_Id'))) echo 'has-error';  ?> ">
										...
										<div class="col-sm-4">
											<select name="Account_Id" class="col-xs-10 col-sm-5 chosen-select"  data-rel="tooltip"  data-placeholder="" >
												<option value="">Choose staff...  </option>
									...
									<div class="form-group  <?php if (!empty(form_error('Amount'))) echo 'has-error';  ?> ">
										...
										<div class="col-sm-9 input-group">
											<span class="input-group-addon">
											 ...
											 <input type="number" id="" name="Amount"  class="col-xs-10 col-sm-5" data-rel="tooltip" autocomplete="off" maxlength="50" value="<?php echo set_value('Amount'); ?>" required="required" />
